...
using NavigationService = WpfSimpleViewManager.Navigate.NavigationService;
...
namespace WpfSimpleViewManager
{
    public class Container
    {
        ...
        {
            _navigationService.AddTransientNavigation<TView>(viewModelInstance);
        }

        void AddSingletonNavigation<TView>(IViewModelBase viewModelInstance) where TView : Control
        {
            _navigationService.AddSingletonNavigation<TView>(viewModelInstance);
        }
